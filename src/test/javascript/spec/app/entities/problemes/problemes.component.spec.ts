...
import { ProblemesComponent } from 'app/entities/problemes/problemes.component';
...
describe('Component Tests', () => {
  describe('Problemes Management Component', () => {
    let comp: ProblemesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProblemesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.problemes && comp.problemes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
